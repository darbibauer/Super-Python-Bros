...
def check_Platforms(mario, x):
    if not mario.jump:
        if (54* 13 + x) <= mario.playerPosX <= (54*15 + x):
            mario.originalplayerPosY = 1000# 700 - 54 * 4 - 65
        elif (54* 24 + x) <= mario.playerPosX <= (54*27 + x):
            mario.originalplayerPosY = 1000# 700 - 54 * 4 - 65
        elif (54* 30 + x) <= mario.playerPosX <= (54*33 + x):
            mario.originalplayerPosY = 1000# s700 - 54 * 4 - 65
    if mario.circlePosX >= 54 * 4 + x:
        mario.originalplayerPos = 700 - 54 * 4 - 65
    elif (0 + x) <= mario.circlePosX <= (54 * 2 + x):
        mario.originalplayerPosY = 700 - 54 * 7 - 65
    elif (54 * 2 + x) <= mario.circlePosX <= (54 * 3 + x):
        mario.originalplayerPosY = 700 - 54 * 6 - 65
    elif (54 * 3 + x) <= mario.circlePosX <= (54 * 4 + x):
